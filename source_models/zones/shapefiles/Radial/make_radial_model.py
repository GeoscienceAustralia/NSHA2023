...
from numpy import array, ones_like, nan, linspace, arange, sqrt, radians
...
azimuths = arange(0, 361, 7.2) # 20 pts

outshp = 'radial_polygons_'+str(res)+'deg.shp'
...
for x in xrng:
    for y in yrng:
        ...
        for azim in azimuths:
           # get diagonal distance - varies with lat
           radiuskm = distance(y, x, y+r2, x+r2)[0]
           #radiuskm = r2
           pointList.append(reckon(y, x, radiuskm, azim))
