...
a_vals = np.log10(data[:,1].astype(float)) # Divide by 4 as cells are overlapping
...
# Set up list to store summed MFD data to check implementation
...
#            print params[k]['CODE']
            ...
            cum_rate = 0
#            print(len(new_mfd.occurrence_rates))
#            print(new_mfd.bin_width)
#            print(new_mfd.min_mag)
...
figname = 'Cuthbertson_2023_cumulative_rates.png'         
plt.savefig(figname)
