...
source_data_filename = 'abValues_trunc_GA_2308.csv'
...
b_values = source_data[:,2] #get_field_data(source_data, 'bVal', 'float')
ids = source_data[:,0] #get_field_data(source_data, 'ID', 'float')
lons = source_data[:,3]
lats = source_data[:,4]
...
outfile = 'RiskFrontiers_2023_trunc_declustered.xml'
